...
**Legend:**
- All VMs start in the private network by default
- Reverse Proxy: Has a public IP attached, making it accessible from the internet
- Frontend, Backend, Database: No public IP, only accessible within the private network
