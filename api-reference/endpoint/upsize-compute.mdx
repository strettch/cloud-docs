---
title: 'Upsize Compute Instance'
openapi: '/api-reference/openapi.json PATCH /computes/{id}/upsize'
---

### Request Reference

Use these slugs for the `newSpecification` field in your request body.
