...
The SC Agent is a lightweight, open-source utility that enables web-based console access to your VMs directly from the Strettch Cloud dashboard. It also provides SSH management capabilities.
