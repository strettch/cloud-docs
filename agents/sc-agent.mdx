...
The SC Agent is a lightweight, open-source utility that enables web-based console access to your VMs directly from the Strettch Cloud dashboard. It manages the SSH connection between your browser and the VM to provide seamless terminal access without requiring SSH client software.
