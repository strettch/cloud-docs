...
The SC Agent is a lightweight, open-source utility that enables web-based console access to your VMs directly from the Strettch Cloud dashboard. It also provides password reset and SSH management capabilities.
...
```
● sc-console-agent.service - SC Console Agent - Secure VM console access management
...
**Note:** After uninstalling, console access and password reset will be unavailable. You'll need to use SSH keys instead.
...
4. Ensure firewall allows port 22 (SSH) and port 60500 (UDP)
