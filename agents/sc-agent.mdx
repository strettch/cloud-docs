---
title: "SC Agent"
description: "Install the SC Agent to enable browser-based console and SSH terminal access to your Strettch Cloud compute instances on Ubuntu and Debian."
---
