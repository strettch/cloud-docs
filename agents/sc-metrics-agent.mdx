...
```
● sc-metrics-agent.service - The DigitalOcean Monitoring Agent
 ...
 Invocation: da1c6db71e3b46f7919b61a295db71c1
   Main PID: 4675 (do-agent)
     ...
     CGroup: /system.slice/sc-metrics-agent.service
             └─4675 /opt/digitalocean/bin/sc-metrics-agent --syslog
...
```
sc-metrics-agent    4675  0.0  0.3 1237180 14712 ?       Ssl  19:14   0:00 /opt/digitalocean/bin/sc-metrics-agent --syslog
