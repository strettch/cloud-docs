...
description: "Install the SC Metrics Agent to collect CPU, memory, disk, and network metrics from your compute instances and view usage graphs in the dashboard."
---
