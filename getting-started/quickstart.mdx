...
This guide walks you through creating a Strettch Cloud account and deploying your first compute instance. You will have a running virtual machine accessible via web console and SSH in about 5 minutes.
