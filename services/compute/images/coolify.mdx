...
Coolify is a self-hostable PaaS — deploy apps, databases, and services on your own infrastructure through a web dashboard.
...
- **Domain name** — optional. Leave it blank and Coolify uses your Compute's IP
- **SMTP** — also optional. Answer `n` and add it later from the UI whenever you want
