...
description: Invite collaborators, assign Member or Admin roles, transfer ownership, remove users, and configure team settings in your Strettch Cloud account.
---
