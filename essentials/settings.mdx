...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](https://mintlify.com/docs/api-playground/overview).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](https://mintlify.com/docs/api-playground/overview)
        </ResponseField>
      </Expandable>
    </ResponseField>
